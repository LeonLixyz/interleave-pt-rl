...
class FSDPArgs:
    ...
    initial_adam_checkpoint: str | None = None
    initial_adam_completion_sha256: str | None = None
    initial_adam_source_tree_sha256: str | None = None
    initial_adam_step: int | None = None
