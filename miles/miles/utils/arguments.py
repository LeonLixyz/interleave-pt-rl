    ...
    def add_miles_arguments(parser):
        ...
        def add_rollout_arguments(parser):
            ...
            parser.add_argument(
                ...
                default=0,
                help=(
                    "Number of tokens prepended by the custom rollout after dataset tokenization. "
                    "The global dataset prefilter reserves this capacity so admitted prompts still "
                    "fit rollout-max-prompt-len after the prefix is added."
                ),
            )
            parser.add_argument(
