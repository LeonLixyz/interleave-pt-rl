...
class RolloutManager:
    ...
    def checkpoint_state(self, rollout_id):
        """Return the cursor that must commit with the training checkpoint."""

        return self.data_source.checkpoint_state(rollout_id)
