...
OUTPUT_DIR = "/checkpoints/C9e18_beta0.03"
...
app = modal.App(
    "rl-reasoning-sweep-C9e18-beta003",
    image=image,
    secrets=[
...
SWEEP_CONFIGS = [
    ("100m", "config/configs/C9e18_beta0.03/100m_alpha0.279.yaml"),
    ("100m", "config/configs/C9e18_beta0.03/100m_alpha0.509.yaml"),
    ("100m", "config/configs/C9e18_beta0.03/100m_alpha0.740.yaml"),
    ("200m", "config/configs/C9e18_beta0.03/200m_alpha0.049.yaml"),
    ("200m", "config/configs/C9e18_beta0.03/200m_alpha0.279.yaml"),
    ("200m", "config/configs/C9e18_beta0.03/200m_alpha0.509.yaml"),
    ("200m", "config/configs/C9e18_beta0.03/200m_alpha0.740.yaml"),
    ("200m", "config/configs/C9e18_beta0.03/200m_alpha0.970.yaml"),
    ("400m", "config/configs/C9e18_beta0.03/400m_alpha0.049.yaml"),
    ("400m", "config/configs/C9e18_beta0.03/400m_alpha0.279.yaml"),
    ("400m", "config/configs/C9e18_beta0.03/400m_alpha0.509.yaml"),
    ("400m", "config/configs/C9e18_beta0.03/400m_alpha0.740.yaml"),
    ("400m", "config/configs/C9e18_beta0.03/400m_alpha0.970.yaml"),
    ("800m", "config/configs/C9e18_beta0.03/800m_alpha0.049.yaml"),
    ("800m", "config/configs/C9e18_beta0.03/800m_alpha0.279.yaml"),
    ("800m", "config/configs/C9e18_beta0.03/800m_alpha0.509.yaml"),
    ("800m", "config/configs/C9e18_beta0.03/800m_alpha0.740.yaml"),
    ("800m", "config/configs/C9e18_beta0.03/800m_alpha0.970.yaml"),
]


def _build_overrides(model_size: str, config_path: str) -> list[str]:
    """Build config overrides for a job."""
    batch_cfg = BATCH_CONFIG.get(model_size, {"batch_size": 16, "gradient_accumulation_steps": 1})
    config_path_obj = Path(config_path)
    budget_beta = config_path_obj.parent.name
    model_alpha = config_path_obj.stem

    budget, beta = budget_beta.split("_beta", 1)
    _, alpha = model_alpha.split("_alpha", 1)
    canonical_name = f"{budget}_{model_size}_alpha{alpha}_beta{beta}"
