...
SWEEP_CONFIGS = [
    # 6p5e18 (29 configs)
    ("50m",   "config/configs/6p5e18/50m_alpha0.050.yaml"),
    ("50m",   "config/configs/6p5e18/50m_alpha0.200.yaml"),
    ("50m",   "config/configs/6p5e18/50m_alpha0.400.yaml"),
    ("50m",   "config/configs/6p5e18/50m_alpha0.750.yaml"),
    ("100m",  "config/configs/6p5e18/100m_alpha0.050.yaml"),
    ("100m",  "config/configs/6p5e18/100m_alpha0.200.yaml"),
    ("100m",  "config/configs/6p5e18/100m_alpha0.400.yaml"),
    ("100m",  "config/configs/6p5e18/100m_alpha0.750.yaml"),
    ("100m",  "config/configs/6p5e18/100m_alpha0.950.yaml"),
    ("200m",  "config/configs/6p5e18/200m_alpha0.050.yaml"),
    ("200m",  "config/configs/6p5e18/200m_alpha0.200.yaml"),
    ("200m",  "config/configs/6p5e18/200m_alpha0.400.yaml"),
    ("200m",  "config/configs/6p5e18/200m_alpha0.750.yaml"),
    ("200m",  "config/configs/6p5e18/200m_alpha0.950.yaml"),
    ("410m",  "config/configs/6p5e18/410m_alpha0.050.yaml"),
    ("410m",  "config/configs/6p5e18/410m_alpha0.200.yaml"),
    ("410m",  "config/configs/6p5e18/410m_alpha0.400.yaml"),
    ("410m",  "config/configs/6p5e18/410m_alpha0.750.yaml"),
    ("410m",  "config/configs/6p5e18/410m_alpha0.950.yaml"),
    ("680m",  "config/configs/6p5e18/680m_alpha0.050.yaml"),
    ("680m",  "config/configs/6p5e18/680m_alpha0.200.yaml"),
    ("680m",  "config/configs/6p5e18/680m_alpha0.400.yaml"),
    ("680m",  "config/configs/6p5e18/680m_alpha0.750.yaml"),
    ("680m",  "config/configs/6p5e18/680m_alpha0.950.yaml"),
    ("1000m", "config/configs/6p5e18/1000m_alpha0.050.yaml"),
    ("1000m", "config/configs/6p5e18/1000m_alpha0.200.yaml"),
    ("1000m", "config/configs/6p5e18/1000m_alpha0.400.yaml"),
    ("1000m", "config/configs/6p5e18/1000m_alpha0.750.yaml"),
    ("1000m", "config/configs/6p5e18/1000m_alpha0.950.yaml"),
    # 3p3e19 (17 configs)
    ("200m",  "config/configs/3p3e19/200m_alpha0.400.yaml"),
    ("200m",  "config/configs/3p3e19/200m_alpha0.750.yaml"),
    ("410m",  "config/configs/3p3e19/410m_alpha0.050.yaml"),
    ("410m",  "config/configs/3p3e19/410m_alpha0.200.yaml"),
    ("410m",  "config/configs/3p3e19/410m_alpha0.400.yaml"),
    ("410m",  "config/configs/3p3e19/410m_alpha0.750.yaml"),
    ("410m",  "config/configs/3p3e19/410m_alpha0.950.yaml"),
    ("680m",  "config/configs/3p3e19/680m_alpha0.050.yaml"),
    ("680m",  "config/configs/3p3e19/680m_alpha0.200.yaml"),
    ("680m",  "config/configs/3p3e19/680m_alpha0.400.yaml"),
    ("680m",  "config/configs/3p3e19/680m_alpha0.750.yaml"),
    ("680m",  "config/configs/3p3e19/680m_alpha0.950.yaml"),
    ("1000m", "config/configs/3p3e19/1000m_alpha0.050.yaml"),
    ("1000m", "config/configs/3p3e19/1000m_alpha0.200.yaml"),
    ("1000m", "config/configs/3p3e19/1000m_alpha0.400.yaml"),
    ("1000m", "config/configs/3p3e19/1000m_alpha0.750.yaml"),
    ("1000m", "config/configs/3p3e19/1000m_alpha0.950.yaml"),
]
...
def _build_overrides(model_size: str, config_path: str) -> list[str]:
    ...
    stem = config_path_obj.stem           # e.g. "100m_alpha0.050"
    canonical_name = f"{budget}_{stem}"   # e.g. "C9e18_100m_alpha0.050"
...
def main(model_filter: str = "", dry_run: bool = False, max_concurrent: int = 8):
    ...
    # Spawn all jobs at once — Modal handles queuing server-side.
    # This way --detach works and jobs survive local process death.
    handles = []
    for name, config_path, overrides in jobs:
        handle = train_h200.spawn(config=config_path, overrides=overrides)
        handles.append((name, handle))
        print(f"  SPAWNED: {name}")

    print(f"\n{len(handles)} jobs spawned on Modal. Waiting for completion...")
