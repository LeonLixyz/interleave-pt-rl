"""
Modal launcher: single pretrain — 32m_C_6p5e18_alpha1.000 (34.40B tokens).

8x H200, bf16. Modal app name: "pretrain".

Usage:
  modal run modal_scripts/launch_32m_alpha1p0.py --dry-run
  modal run --detach modal_scripts/launch_32m_alpha1p0.py
"""
import os
import sys
...
def main(dry_run: bool = False):
    cfg = "config/configs/6p5e18_small/32m_alpha1.000.yaml"
    overrides = [
        "training.gpu_peak_tflops=989",
        "training.cache_size=0",
        "training.mixed_precision=bf16",
    ]
    print(f"Launcher: 32m_alpha1.000 (6p5e18, 34.40B tokens)")
    print(f"  config: {cfg}")
    ...
    print(f"SPAWNED: 32m_alpha1.000 (handle={handle.object_id})")
