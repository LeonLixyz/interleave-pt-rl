"""
Modal launcher: 20m alpha=0.300 and alpha=0.600 at C_total=6.5e18.

Jobs (2 total):
  - 20m_alpha0.300 (15.854B tokens)
  - 20m_alpha0.600 (31.709B tokens)

Each job: 8x H200, bf16, lr=1e-3 cosine to eta_min=1e-4.

Usage:
  modal run modal_scripts/launch_20m_alpha0p3_0p6.py --dry-run
  modal run --detach modal_scripts/launch_20m_alpha0p3_0p6.py
"""
import os
...
JOBS = [
    "config/configs/6p5e18_small/20m_alpha0.300.yaml",  # 15.854B
    "config/configs/6p5e18_small/20m_alpha0.600.yaml",  # 31.709B
]
...
def main(dry_run: bool = False):
    print(f"20m alpha=0.300/0.600 launcher: {len(JOBS)} jobs")
