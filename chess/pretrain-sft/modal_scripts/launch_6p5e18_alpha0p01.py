"""
Modal launcher: 6p5e18, alpha=0.010 sweep across 5 model sizes.

Jobs (5 total):
  - 5m_alpha0.010   (2.108B tokens)
  - 10m_alpha0.010  (916M tokens)
  - 20m_alpha0.010  (528M tokens)
  - 32m_alpha0.010  (343.87M tokens)
  - 50m_alpha0.010  (230M tokens)

Each job: 8x H200, bf16. Modal app name: "training".

Usage:
  modal run modal_scripts/launch_6p5e18_alpha0p01.py --dry-run    # preview
  modal run --detach modal_scripts/launch_6p5e18_alpha0p01.py     # launch
"""
import os
import sys
...
JOBS = [
    "config/configs/6p5e18_small/5m_alpha0.010.yaml",   # 2.108B
    "config/configs/6p5e18_small/10m_alpha0.010.yaml",  # 916M
    "config/configs/6p5e18_small/20m_alpha0.010.yaml",  # 528M
    "config/configs/6p5e18_small/32m_alpha0.010.yaml",  # 343.87M
    "config/configs/6p5e18_small/50m_alpha0.010.yaml",  # 230M
]
...
def main(dry_run: bool = False):
    print(f"6p5e18 alpha=0.010 launcher: {len(JOBS)} jobs")
