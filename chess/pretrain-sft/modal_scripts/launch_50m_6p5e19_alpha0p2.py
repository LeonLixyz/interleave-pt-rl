"""
Modal launcher: single pretrain — 50m_C_6p5e19_alpha0.200 (42.60B tokens).

8x H200, bf16. Modal app name: "pretrain".

Usage:
  modal run modal_scripts/launch_50m_6p5e19_alpha0p2.py --dry-run
  modal run --detach modal_scripts/launch_50m_6p5e19_alpha0p2.py
"""
import os
...
def main(dry_run: bool = False):
    cfg = "config/configs/6p5e19_leon/50m_alpha0.200.yaml"
    overrides = [
        "training.gpu_peak_tflops=989",
        "training.cache_size=0",
        "training.mixed_precision=bf16",
    ]
    print(f"Launcher: 50m_alpha0.200 (6p5e19, 42.60B tokens)")
    print(f"  config: {cfg}")
    ...
    print(f"SPAWNED: 50m_C_6p5e19_alpha0.200 (handle={handle.object_id})")
