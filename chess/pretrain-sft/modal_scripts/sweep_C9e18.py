...
SWEEP_CONFIGS = [
    ...
    ("100m",  "config/configs/C9e18/100m_alpha0.050.yaml"),
    ("100m",  "config/configs/C9e18/100m_alpha0.100.yaml"),
    ("100m",  "config/configs/C9e18/100m_alpha0.200.yaml"),
    ("100m",  "config/configs/C9e18/100m_alpha0.400.yaml"),
    ("100m",  "config/configs/C9e18/100m_alpha0.700.yaml"),
    ("100m",  "config/configs/C9e18/100m_alpha0.950.yaml"),
    ...
    ("680m",  "config/configs/C9e18/680m_alpha0.050.yaml"),
    ("680m",  "config/configs/C9e18/680m_alpha0.100.yaml"),
    ("680m",  "config/configs/C9e18/680m_alpha0.200.yaml"),
    ("680m",  "config/configs/C9e18/680m_alpha0.400.yaml"),
    ("680m",  "config/configs/C9e18/680m_alpha0.700.yaml"),
    ("680m",  "config/configs/C9e18/680m_alpha0.950.yaml"),
    ...
    # C1p9e19 (14 configs)
    ("100m",  "config/configs/C1p9e19/100m_alpha0.400.yaml"),
    ("100m",  "config/configs/C1p9e19/100m_alpha0.700.yaml"),
    ("200m",  "config/configs/C1p9e19/200m_alpha0.400.yaml"),
    ("200m",  "config/configs/C1p9e19/200m_alpha0.700.yaml"),
    ("200m",  "config/configs/C1p9e19/200m_alpha0.950.yaml"),
    ("410m",  "config/configs/C1p9e19/410m_alpha0.400.yaml"),
    ("410m",  "config/configs/C1p9e19/410m_alpha0.700.yaml"),
    ("410m",  "config/configs/C1p9e19/410m_alpha0.950.yaml"),
    ("680m",  "config/configs/C1p9e19/680m_alpha0.400.yaml"),
    ("680m",  "config/configs/C1p9e19/680m_alpha0.700.yaml"),
    ("680m",  "config/configs/C1p9e19/680m_alpha0.950.yaml"),
    ("1000m", "config/configs/C1p9e19/1000m_alpha0.400.yaml"),
    ("1000m", "config/configs/C1p9e19/1000m_alpha0.700.yaml"),
    ("1000m", "config/configs/C1p9e19/1000m_alpha0.950.yaml"),
]
