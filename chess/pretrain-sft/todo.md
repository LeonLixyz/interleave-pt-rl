1. make the training more organized, we would like to have sth like auto resuming and etc.
2. we would like to add in modal run options an example is here: """
...
3. have a better documentation. also find any bugs we might have. do tests on 8 gpus and use uv run and etc.