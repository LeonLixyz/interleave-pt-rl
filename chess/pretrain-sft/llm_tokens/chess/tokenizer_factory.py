...
_LAZY_REGISTRY = {
    ...
    "SanTokenizer": ("llm_tokens.chess.san_tokenizer", "SanTokenizer"),
    "UciTokenizer": ("llm_tokens.chess.uci_tokenizer", "UciTokenizer"),
    "BpeTokenizer": ("llm_tokens.chess.bpe_tokenizer", "BpeTokenizer"),
}
