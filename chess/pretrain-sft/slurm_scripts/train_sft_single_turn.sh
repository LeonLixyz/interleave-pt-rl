...
configs=(
  "../../config/configs/qwen_sft/sft_config_multi_path_2048.yaml"
)
lrs=("3e-4")

PRETRAIN_ROOT="${BASE}/LLM-Pretraining/checkpoints/C_6p5e18"
...
# Format: C{total_compute}_{modelsize}_alpha{alpha}_beta{beta}
declare -A TRAIN_DATA_DIR_BY_MODEL_ID=(
  ["C9e18_200m_alpha0.740_beta0.03"]="${BASE}/LLM-Pretraining/data/sft/cot_data_puzzle_seq_qwen/qwen06b_final_step26528/hf_model_seed0_evalminimax_candpolicy_nc8_nt10_nta8_d20_dmrandom_wt300_pm8_inj"
)
declare -A DATA_NAME_BY_MODEL_ID=(
  ["C9e18_200m_alpha0.740_beta0.03"]="200m_generated"
)
...
cot_fields=(
  "cot_by_method.solution_continuation.cot_format"
)
cot_types=(
...
#SBATCH --job-name=sft_single_${job_tag}_${cot_short}
#SBATCH --output=slurm_logs/sft_single_${job_tag}_${cot_short}_%j.log
